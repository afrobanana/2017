            ...
            <section className="guide">
                ...
                <div className="box-container">
                    <div className="box">
                        ...
                        <p>
                            With the brand new ABR Square at the heart of the festival this year, there will be a great hub of activity for all things hip and happening! With countless stalls dishing up all sorts of foods to tantalize your taste buds, topped by the dreamiest drinks and cocktails to lift your spirits, crowds can kick back and enjoy the sounds of the ABR Radio and live DJ sets taking everyone on a faraway journey.
                        </p>
                    </div>
                    <div className="box">
                        <h3>Daytime Activities</h3>
                        <p>Kids can also take part in the fun with a special area set up specifically for little ones where fun, education and innovation will come together in creative workshops. And for all those adults looking to relax and unwind, there will be plenty of wellness activities to enjoy, including yoga and Tai Chi.</p>
                        <p>There will also be inspirational talks, as well as Open Mic sessions giving you the chance to share your thoughts. Geodesic domes on site will be encouraging community practices as festival-goers get the chance to charge mobile phones and enjoy collective festival mix tapes.  And when things heat up a little? Cooling stations should do the trick!</p>
                    </div>
                    <div className="box">
                        <h3>Artistic Explorations</h3>
                        <p>A highly experiential event, the ABR Festival is characterised by a strong participatory ethos, with special attention given to creativity and artistic endeavours. With a wide range of artists across all sorts of creative fields partaking in the event, festival goers will have the chance to enjoy a range of exciting interactive projects and experiences. From an emphasis on eco awareness and recycling, to illustration and street art, participants will be encouraged to expand their horizons and experience art in a whole new way.</p>
