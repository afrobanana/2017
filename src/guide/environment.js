...
export default () =>
    <section className="guide-environment">
        ...
        <dl>
            ...
            <dd>We have ensured that a team of professional first aid doctors/medics will be patrolling the site at all times to provide any help needed in case of emergency. Please contact your nearest security guard if help is required.</dd>

            <dt>FIRE SAFETY</dt>
            <dd>Fire hazards are no small deal during the summer months and we wouldn't want to burn the lovely forest down, so please be aware that lighting fire is strictly forbidden on the festival premises!</dd>
