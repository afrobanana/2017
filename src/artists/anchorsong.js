import image from './images/07_ANCHORSONG.png'

export const name = 'ANCHORSONG (LIVE)'

export default `
# ${ name }

SOULFUL; SAMPLE-HEAVY DOWNTEMPO; AFRO-HOUSE

<a href=http://bit.ly/ANCHORSONG target=_blank>
    http://bit.ly/ANCHORSONG
</a>
